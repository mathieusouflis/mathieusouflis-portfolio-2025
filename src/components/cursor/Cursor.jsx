...
const Cursor = () => {
  ...
  return (
    <div
      className={`cursor z-50 fixed box-content flex items-center justify-center min-w-3 min-h-3 aspect-square rounded-full border border-white pointer-events-none mix-blend-exclusion transition-all duration-[300ms] ease-slow ${text ? 'w-24 h-24' : 'w-3 h-3'}`}
    >
